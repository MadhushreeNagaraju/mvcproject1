...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", name=" + name + ", email=" + email + ", phno=" + phno + ", age=" + age
				+ ", gender=" + gender + ", role=" + role + ", getId()=" + getId() + ", getName()=" + getName()
				+ ", getEmail()=" + getEmail() + ", getPhno()=" + getPhno() + ", getAge()=" + getAge()
				+ ", getGender()=" + getGender() + ", getRole()=" + getRole() + ", getClass()=" + getClass()
